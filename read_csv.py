...
df_t= df1
#print df_t
list_t=[len(df_t[str(2006)]),len(df_t[str(2006):str(2007)]),len(df_t[str(2006):str(2008)]),len(df_t[str(2006):str(2009)]),len(df_t[str(2006):str(2010)]),len(df_t[str(2006):str(2011)]),len(df_t[str(2006):str(2012)]),len(df_t[str(2006):str(2013)]),len(df_t[str(2006):str(2014)]),len(df_t[str(2006):str(2015)]),len(df_t[str(2006):str(2016)]),len(df_t[str(2006):str(2017)])]
print list_t
j=1
